...
from utils.logging_config import get_logger, log_key_value
...
class DatabaseOperations:
    ...
    def _measure_query_performance(self, operation: str):
        ...
        class QueryPerformanceContext:
            ...
            def __exit__(self, exc_type, exc_val, exc_tb):
                ...
                self.db_ops.query_metrics['average_query_time'] = (
    ...
    def get_tasks_by_status_batch(self, status: TaskStatus, page_size: int = 100, 
                                  start_cursor: Optional[str] = None, 
                                  use_cache: bool = True) -> Tuple[List[Dict[str, Any]], Optional[str]]:
        """
        ...
        with self._measure_query_performance(operation):
            try:
                ...
                if isinstance(response, dict):
                    ...
                    log_key_value(logger, f"📊 Found tasks with status '{status.value}'", 
    ...
    def get_tasks_by_status_all(self, status: TaskStatus, max_tasks: Optional[int] = None,
        ...
        with self._measure_query_performance(operation):
            ...
            while True:
                page_count += 1
                tasks_batch, next_cursor = self.get_tasks_by_status_batch(
                    status, page_size=100, start_cursor=next_cursor, use_cache=False
                )
