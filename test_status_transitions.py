...
def test_transition_validation():
    ...
    for from_status, to_status in valid_transitions:
        assert status_manager.is_valid_transition(from_status, to_status), \
            f"Should allow transition: {from_status} → {to_status}"
    ...
    for from_status, to_status in invalid_transitions:
        assert not status_manager.is_valid_transition(from_status, to_status), \
            f"Should reject transition: {from_status} → {to_status}"
