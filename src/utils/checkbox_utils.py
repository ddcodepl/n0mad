...
class CheckboxParser:
    ...
    @classmethod
    def parse_checkbox_property(cls, property_name: str, property_data: Any) -> Optional[CheckboxProperty]:
        """
    ...
    @classmethod
    def _parse_dict_property(cls, property_name: str, property_data: Dict[str, Any]) -> Optional[CheckboxProperty]:
    ...
    @classmethod
    def _parse_string_property(cls, property_name: str, property_data: str) -> Optional[CheckboxProperty]:
...
class CheckboxValidator:
    ...
    @classmethod
    def validate_checkbox_configuration(
        cls,
        task_data: Dict[str, Any],
        required_checkboxes: List[str] = None,
        optional_checkboxes: List[str] = None,
    ) -> Dict[str, Any]:
        """
    ...
    def validate_checkbox_value(
        ...
        if checkbox_property.confidence < min_confidence:
            validation["warnings"].append(f"Low confidence ({checkbox_property.confidence:.2f}) in checkbox value")

        # Check expected value
        if expected_value is not None and checkbox_property.value != expected_value:
            validation["errors"].append(f"Checkbox value {checkbox_property.value} does not match expected {expected_value}")
...
class CheckboxUtilities:
    ...
    @staticmethod
    def find_checkbox_properties(task_data: Dict[str, Any], search_names: List[str]) -> List[CheckboxProperty]:
        """
    ...
    def get_checkbox_summary(task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "checkboxes": [],
            "format_distribution": {},
            "confidence_stats": {"min": 1.0, "max": 1.0, "avg": 1.0},
        }
        ...
        for prop_name, prop_data in properties.items():
            ...
            if checkbox_prop:
                ...
                format_type = checkbox_prop.format_type.value
                summary["format_distribution"][format_type] = summary["format_distribution"].get(format_type, 0) + 1
    ...
    @staticmethod
    def normalize_checkbox_data(task_data: Dict[str, Any], target_format: CheckboxFormat = CheckboxFormat.SIMPLE) -> Dict[str, Any]:
        """
        ...
        for prop_name, prop_data in properties.items():
            ...
            if checkbox_prop:
                ...
                if target_format == CheckboxFormat.SIMPLE:
                    normalized_properties[prop_name] = {"value": checkbox_prop.value}
