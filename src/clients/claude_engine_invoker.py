...
USE MCP TOOLS: You have direct access to Task Master MCP tools - use them instead of CLI commands."""
    ...
    def invoke_claude_engine(self, ticket_id: str, page_id: str) -> ClaudeInvocation:
        ...
        customized_prompt = self.base_prompt_template.format(ticket_id=ticket_id, page_id=page_id)
    ...
    def invoke_claude_engine_with_taskmaster(self, task_id: str, page_id: str) -> ClaudeInvocation:
        ...
        customized_prompt = self.taskmaster_prompt_template.format(task_id=task_id, page_id=page_id)
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        with self._invocation_lock:
            ...
            successful_durations = [
                i.duration_seconds for i in self._invocation_history if i.result == InvocationResult.SUCCESS and i.duration_seconds is not None
            ]
