...
from core.processors.multi_queue_processor import (
    MultiQueueProcessor, 
    QueuedTaskItem, 
    ProcessingResult,
    ProcessingSession
)
from core.managers.branch_integration_manager import (
    BranchIntegrationManager,
    BranchIntegrationOperation,
    IntegrationResult
)
...
class BranchIntegratedProcessor(MultiQueueProcessor):
    ...
    def _process_task_queue_with_branches(self, 
                                          task_queue: List[BranchIntegratedTaskItem], 
    ...
    def _process_single_task_with_branch_integration(self, 
                                                     task_item: BranchIntegratedTaskItem) -> Dict[str, Any]:
        """
    ...
    def _record_processing_result(self, result: Dict[str, Any]):
        ...
        elif status in [BranchProcessingResult.FAILED, BranchProcessingResult.FAILED_BRANCH_ONLY, BranchProcessingResult.FAILED_TASK_ONLY]:
    ...
    def get_branch_integration_statistics(self) -> Dict[str, Any]:
        ...
        if self.enable_branch_integration:
            ...
            return {
                **base_stats,
                "branch_integration_enabled": False
            }