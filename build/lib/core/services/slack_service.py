...
from utils.slack_config import SlackConfig, MessagePriority, get_slack_config
...
class SlackMessageOperation:
    ...
    def can_retry(self, max_retries: int = 3) -> bool:
        ...
        return (self.message.retry_count < max_retries and 
                self.result in [SlackMessageResult.FAILED, SlackMessageResult.RATE_LIMITED])
...
class SlackApiClient:
    ...
    def send_message(self, message: SlackMessage) -> SlackMessageOperation:
        ...
        operation = SlackMessageOperation(
            operation_id=operation_id,
            message=message,
            result=SlackMessageResult.FAILED
        )
