...
class GitBranchService:
    ...
    def create_branch_for_task(self, task_id: str, task_title: str, base_branch: Optional[str] = None, force: bool = False) -> BranchOperation:
        """
...
class CheckboxStateDetector:
    ...
    def extract_branch_preferences(cls, task: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        preferences = {"create_branch": False, "base_branch": None, "branch_name_override": None}
