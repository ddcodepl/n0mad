...
class AdvancedNameValidator:
    ...
    REMOVE_CATEGORIES = {'Cc', 'Cf', 'Cs', 'Co', 'Cn', 'Mn', 'Me', 'Mc'}  # Control, format, surrogate, private, unassigned, marks
    ...
    # Reserved names
    RESERVED_NAMES = {
        'master', 'main', 'head', 'origin', 'upstream',
        'refs', 'HEAD', 'FETCH_HEAD', 'ORIG_HEAD',
        'MERGE_HEAD', 'cherry-pick-head'
    }
    ...
    def validate_and_sanitize(self, 
                              ...
                              context: str = "default") -> NameValidationReport:
        """
    ...
    def _finalize_report(self, report: NameValidationReport, cache_key: str) -> NameValidationReport:
        ...
        logger.debug(f"🔍 Validation complete: '{report.original_name}' → '{report.sanitized_name}' "
