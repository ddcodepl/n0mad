...
class TestCheckboxStateDetector(unittest.TestCase):
    ...
    def test_is_checkbox_checked_various_formats(self):
        ...
        self.assertTrue(self.detector._is_checkbox_checked({
            "type": "checkbox",
            "checkbox": True
        }))
        ...
        task_data = {
            "properties": {
                ...
                "Branch Name": {
                    ...
                    "rich_text": [
                        {
                            "plain_text": "feature-custom-name"
                        }
                    ]
                }
            }
        ...
        mixed_task = {
            "properties": {
                ...
                "Branch Name": {
                    "type": "rich_text",
                    "rich_text": [
                        {"plain_text": "hotfix-security-patch"}
                    ]
                }
            }
        }
