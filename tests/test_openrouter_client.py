...
from openrouter_client import (
    OpenRouterClient, OpenRouterError, OpenRouterAuthenticationError,
    OpenRouterRateLimitError, OpenRouterTimeoutError, call_openrouter
)
...
def test_convenience_function():
    ...
    with patch('openrouter_client.OpenRouterClient') as mock_client_class:
        ...
        mock_client.call_openrouter.assert_called_once_with(
            "test/model", "test prompt", None
        )
