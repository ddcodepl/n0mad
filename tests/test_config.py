...
from src.config import ConfigurationManager, DEFAULT_MODEL, DEFAULT_ENABLE_CONTINUOUS_POLLING, DEFAULT_POLLING_INTERVAL_MINUTES, MIN_POLLING_INTERVAL_MINUTES
...
class TestConfigurationManager(unittest.TestCase):
    ...
    def test_get_all_config(self):
        ...
        self.assertEqual(config_dict['enable_continuous_polling'], self.config_manager.get_enable_continuous_polling())
        self.assertEqual(config_dict['polling_interval_minutes'], self.config_manager.get_polling_interval_minutes())
