...
from config import MAX_POLLING_INTERVAL_MINUTES, MIN_POLLING_INTERVAL_MINUTES, ConfigurationManager
...
def test_backward_compatibility():
    ...
    config.update_config({"enable_continuous_polling": True, "polling_interval_minutes": 15})
