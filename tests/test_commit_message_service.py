...
class TestCommitMessageGenerator(unittest.TestCase):
    ...
    def test_generate_basic_commit_message(self):
        ...
        self.assertRegex(message, r'^(feat|fix|docs|style|refactor|perf|test|build|ci|chore|revert|wip)(\(.+\))?!?:')
    ...
    def test_scope_extraction_from_ticket_id(self):
        ...
        task_with_scope = TaskCommitData(
            ticket_id="NOMAD-AUTH-123",
            task_title="Add login functionality"
        )
    ...
    def test_description_cleaning(self):
        ...
        test_cases = [
            ...
            ("NOMAD-123: Implement user authentication", "NOMAD-123", "implement user authentication"),
    ...
    def test_custom_commit_type_override(self):
        ...
        message = self.generator.generate_commit_message(
