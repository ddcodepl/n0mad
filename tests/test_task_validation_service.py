...
from utils.checkbox_utils import CheckboxProperty, CheckboxFormat
...
class TestTaskStatusValidationService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.service = TaskStatusValidationService(
    ...
    def test_validation_history_tracking(self):
        ...
        result1 = self.service.validate_task_transition(
            self.test_page_id, "In progress", "Done"
        )
        result2 = self.service.validate_task_transition(
            self.test_page_id, "Ideas", "To Refine"  # Won't require validation
        )
    ...
    def test_error_code_handling(self):
        ...
        test_cases = [
            ...
            (
                lambda: setattr(self.mock_notion_client, 'get_page', 
